...
# Django settings for pando project.
import os
...
SECRET_KEY = 'm$_cx0(6^756o88m#b7wv+afgvd4vi*1b3brhy=$38oyk_p0(0'
...
ROOT_URLCONF = 'pando.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'pando.wsgi.application'
